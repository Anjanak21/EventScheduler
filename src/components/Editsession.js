...
import { createSession, editsession } from '../Api/api';
...
//   console.log(id);
      ...
      editsession(id)
        .then((response) =>{
            ...
            setFormData({
                ...
                speakers_name:session.speakers_name||'',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await editsession(id,formattedData); 
      navigate('/')
      // setFetch(true);
    ...
    <Container className="mt-3" style={{ float: 'left' }}>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Button
          ...
          onClick={() => setFormData({ event_id: '', title: '', start_time: '', end_time: '',speakers_name:'' })}
        >
          Cancel
        </Button>
      </Form>
